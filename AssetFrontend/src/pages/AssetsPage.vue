...
async function addAsset() {
  ...
  try {
    await axios.post(`${API_BASE_URL}/api/assets`, newAsset.value);
...
async function updateAsset() {
  ...
  try {
    await axios.put(`${API_BASE_URL}/api/assets/${editAssetId.value}`, newAsset.value);
...
async function exportExcel() {
  try {
    const response = await axios.get(`${API_BASE_URL}/api/assets/export`, {
      responseType: "blob",
    });
...
<style scoped>
@import "../css-styling/AssetsPage.css";
</style>